About perl-compress-bgzf-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/perl-compress-bgzf-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/perl-compress-bgzf-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add perl-compress-bgzf
# for installing globally
pixi global install perl-compress-bgzf
```
...
It is possible to list all of the versions of `perl-compress-bgzf` available on your platform:
...
```
pixi search perl-compress-bgzf --channel conda-forge
```
